...
from src.utils.modules import DenseNetwork
from src.utils.torch_utils import get_act
from src.utils.utils import key_change
...
def change_kwargs_for_made(old_kwargs):
    """Converts a dictionary of keyword arguments for configuring a utils
...
def stacked_norm_flow(
    ...
    # For MADE netwoks change kwargs from utils to nflows format
    if param_func == "made":
